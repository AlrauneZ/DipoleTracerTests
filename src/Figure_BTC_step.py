...
tau = dtt.setup_time(tmin = 10**tmin,tmax = 10**tmax, timesteps=100)
step = 10
# step = tau[np.argmin(abs(tau-step))] # select step as a value of the tau array
...
for v in var_list:
    ...
    cdf = dtt.btc_step_flux(tau,v,step)
